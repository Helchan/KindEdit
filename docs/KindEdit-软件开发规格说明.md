...
- 支持 PDF 页面阅读，包括多页滚动、页码显示、缩放显示和主题适配；右侧 PDF 预览区域按住 Ctrl 并滚动鼠标滚轮时，向上滚动放大内容，向下滚动缩小内容，缩放范围与工具栏缩放按钮一致为 50% 到 250%；页面渲染不得阻塞标签切换、滚动和其他主交互。
